...
function Banner() {
  return (
    <>
      <div className="container flex-col-reverse lg:flex-row flex gap-[50px] lg:gap-[106px] justify-center items-center px-[50px] lg:px-[135px] py-[50px] lg:py-[100px] ">
          ...
          <form action="#">
            <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
              ...
              <div>
                <button
                  type="submit"
                  className="py-3 px-8 w-full text-sm font-medium text-center text-white  border cursor-pointer bg-pMain border-primary-600  hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 "
                >
                  Subscribe
                </button>
              </div>
